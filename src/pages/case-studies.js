...
const CaseStudies = () => {
  ...
  return (
    <>
      <GatsbySeo
        title="iQuest Case Studies for Complex Managed IT Applications in Perth"
        description="iQuest successfully identifies the IT requirements of businesses and expertly handles all management and support requirements."
      />
