  ...
  return (
    <>
      <InternalLayout title="Privacy Policy">
        ...
        <h2 className="mt-12 text-blue-light" data-animate>General Provisions</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Collection of Information</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Use of Information</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Disclosure</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Registration and use of Tools</h2>
        <p data-animate>
        ...
        <p data-animate>
        19). In agreeing to the iQuests PP:<br/><br/>
        You agree to receive marketing and advertising information and communications from iQuest, unless you direct iQuest you do not consent to the receipt of such information, which you may do by following the directions contained in the relevant piece of advertising or marketing communication.<br/><br/> You agree you are not permitted to take any step to harvest any personal or sensitive information from the Site or any of its contents which relates to another person.<br/><br/> You agree you are not permitted to use any system or function of the Site to communicate or propagate spam, viruses or any other software which may interfere with iQuest or any other system.<br/><br/> You agree iQuest may scan any and all email messages or other electronic communications you send to iQuest or the Site using automated systems in order to locate and identify any malicious activity or prohibited content in any such emails or other electronic communications.<br/><br/> You agree to the provision of the information referred to in the T&Cs to the persons identified therein, in order to enable iQuest to supply you with the facilitation of the Services.
        </p>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Access and Complaints</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Information Security</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Cookies</h2>
        <p data-animate>
        ...
        <h2 className="mt-12 text-blue-light" data-animate>Hosting</h2>
        <p data-animate>
