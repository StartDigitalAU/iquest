        ...
        <div className="lg:mx-auto lg:max-w-6xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
          <div className="px-4 max-w-6xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
            <div className="text-white flex flex-col space-y-6">
              ...
              <Link data-animate to="/contact-us" className="btn btn-blue">Get started</Link>
            </div>
            <div data-animate-left className="mt-8 border-t border-gray-200 pt-6">
              <blockquote>
                <div>
          ...
          <div className="mt-12 sm:mt-16 lg:mt-0">
            <div data-animate-right className="px-4 sm:pl-6 lg:px-0 lg:m-0 lg:relative lg:h-full">
              <StaticImage
