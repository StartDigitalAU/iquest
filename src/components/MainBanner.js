    ...
    <div className="max-w-7xl mx-auto px-4 py-16 lg:py-32 xl:px-0 xl:py-46">
      ...
      >
        ...
        <p className="text-white lg:w-2/3">
          “I cannot thank iQuest enough. Professional, responsive and willing to
          assist on such short notice”.{" "}
          <span className="font-bold">Elvira Mustafa</span>
        </p>
        <a
          href="https://www.google.com/search?q=iquest&oq=iquest&aqs=chrome..69i57j46i175i199i512j0i512j0i10i512j69i60l3j69i61.1321j0j7&sourceid=chrome&ie=UTF-8#lrd=0x2a32bad600ac12cb:0x11b59d901fa06ebf,1,,,"
          target="_blank"
          rel="noopener"
        >
          <StaticImage
            ...
            src="../images/google-stars.png"
            width={180}
            alt="A 5-star Google review rating"
          />
        </a>
      </div>
