...
export default function MainBanner() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 lg:py-32 xl:px-0 xl:py-48">
      <div data-animate className="relative z-10 transform lg:w-2/3 -translate-y-4">
        ...
        <h1 className="text-4xl leading-tight lg:text-7xl text-blue-lighter">iQuest provide exceptional IT support</h1>
